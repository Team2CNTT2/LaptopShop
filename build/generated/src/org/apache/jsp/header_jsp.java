...
public final class header_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<li><i class=\"glyphicon glyphicon-envelope\" ></i><a href=\"mailto:contact@hutechguitarshop.com\">@JennyBoShop.com</a></li>\n");
      out.write("\t\t\t\t\t\t<li><i class=\"glyphicon glyphicon-earphone\" ></i>+84377944515</li>\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
...
if(user==null){ 
      ...
      out.write("\t\t\t\t\t\t\t<h1 class=\"animated wow pulse\" data-wow-delay=\".5s\"><a href=\"index.jsp\">Jenny Bo<span> SHOP</span></a></h1>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t</div> \n");
      ...
      out.write("                                                        <li style=\"padding: 10px 0px 0px 10px; \">\n");
      out.write("                                                            <form method=\"post\" action=\"/LaptopShop/ManagerProductServlet\">\n");
      out.write("                                                                <input type=\"text\" placeholder=\"Nhập tìm kiếm...\" name=\"txtsearch\" style=\"border: 0.5px solid gray; padding: 5px 0px 6px 5px; border-radius: 2.5px; opacity: 0.7\"></input>\n");
      out.write("                                                                <input type=\"submit\" value=\"Search\" name=\"command\" style=\"background-color: lightblue; border: 0.5px solid gray; border-radius: 2.5px; padding: 5px 4px 2.9px 4px; text-align: center; opacity: 0.7\"></input>\n");
      out.write("                                                            </form>\n");
      out.write("                                                        </li>\n");
      out.write("\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t</div>\n");
